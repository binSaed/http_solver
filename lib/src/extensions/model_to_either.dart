...
extension ModelToEither<T  extends BaseModelForHttpSolver> on Future<T> {//extends BaseModelForHttpSolver
  Future<Either<Failure, T>> toEither() async {//<T extends BaseModelForHttpSolver>
